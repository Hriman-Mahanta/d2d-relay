...
public:
  ...
  struct UeSdRsrqMeasurementsElement
  {
    uint64_t m_relayId; ///< Id of the measured Relay UE
    uint32_t m_serviceCode; ///< Service code offered by the Relay UE
    double m_sdRsrq;  ///< Measured SD-RSRP [dBm]
  };
  ...
  struct UeSdRsrqMeasurementsParameters
  {
    std::vector <struct UeSdRsrqMeasurementsElement> m_ueSdRsrqMeasurementsList; ///< List of SD-RSRP measurements to be reported to the RRC by the PHY
  };
  ...
  virtual void ReportUeSdRsrqMeasurements (LteUeCphySapUser::UeSdRsrqMeasurementsParameters params) = 0;
};
...
public:
  ...
  virtual void ReportUeSdRsrqMeasurements (LteUeCphySapUser::UeSdRsrqMeasurementsParameters params);
...
template <class C>
void
MemberLteUeCphySapUser<C>::ReportUeSdRsrqMeasurements (LteUeCphySapUser::UeSdRsrqMeasurementsParameters params)
{
  m_owner->DoReportUeSdRsrqMeasurements (params);
}
