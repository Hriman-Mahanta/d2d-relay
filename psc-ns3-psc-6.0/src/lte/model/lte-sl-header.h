...
public:
  ...
  void SetMyVariable(uint8_t variable);
  ...
  uint32_t GetMyVariable () const;
  std::vector<uint8_t> GetMyVector () const;
...
private:
  ...
  uint8_t m_myvar; //My variable
  std::vector<uint8_t> m_myvector;
